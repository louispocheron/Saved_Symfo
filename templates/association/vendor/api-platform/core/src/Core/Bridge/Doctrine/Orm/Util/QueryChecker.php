...
use ApiPlatform\Doctrine\Orm\Util\QueryChecker as NewQueryChecker;
...
final class QueryChecker
{
    ...
    {
        @trigger_error(sprintf('The use of "%s::hasOrderByOnToManyJoin()" is deprecated since 2.4 and will be removed in 3.0. Use "%s::hasOrderByOnFetchJoinedToManyAssociation()" instead.', __CLASS__, NewQueryChecker::class), \E_USER_DEPRECATED);
