...
class getSecurityControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.cG5C0fD'] ?? $container->load('get_ServiceLocator_CG5C0fDService'))->withContext('App\\Controller\\SecurityController', $container));
