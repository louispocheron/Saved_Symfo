 ...
 */
final class Version20220608092906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE associations ADD region VARCHAR(255) DEFAULT NULL');
    }
